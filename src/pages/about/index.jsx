  ...
  return (
    <div className='main'>
      <div className="content_block">
        ...
        <p className="about_text">I enjoy working on interesting and challenging projects. I have experience both working in teams and independently. I have a strong desire and determination to develop my skills in frontend development.</p>
      </div>
    </div>
  )
}